...
<div id="container">
	...
	<div id="outbox">
		...
		<div id="contents">
			<div id="mypage">
				<h2>
					<strong>주문/배송 조회</strong><span>회원님이 구매하신 주문내역 및 배송정보를 확인하실 수
						있습니다.</span>
				</h2>
					...
					<table summary="주문일자/주문번호, 상품명, 가격, 수량, 주문상태 순으로 조회를 하실수 있습니다."
						...
						<tbody>
							<c:forEach items="${list }" var="mbdto">
								<tr>
									<td>
										<p class="day">${mbdto.memberDto.mdat e }</p>
										<p class="orderNum">${mbdto.boardDto.bno }</p>
									</td>
									<td class="left">${mbdto.boardDto.btitle }</td>
						...
						<ul>
							...
							<li><span class="chk"><input type="checkbox" /></span> <span
								class="img"><img src="../images/img/sample_product.jpg"
									alt="상품" /></span> <span class="name"><a href="#">쟈뎅 오리지널
										블루마운틴 블렌드 원두커피백 15P</a></span> <span class="price">4,330원</span></li>
				...
				<div class="tab_basket disnone">
					...
					<div class="productList">
						<ul>
							...
							<li><span class="chk"><input type="checkbox" /></span> <span
								class="img"><img src="../images/img/sample_product.jpg"
									alt="상품" /></span> <span class="name"><a href="#">쟈뎅 장바구니
										블루마운틴 블렌드 원두커피백 15P</a></span> <span class="price">4,330원</span></li>
				...
				<script type="text/javascript">
					$(function() {
						function distance() {
							...
							if (winWidth > 767) {
								$(".productList ul li:nth-child(4n+4)").css(
										"padding", "0 0 0 0");
							} else {
								$(".productList ul li:nth-child(4n+4)").css(
										"padding", "0 10px");
